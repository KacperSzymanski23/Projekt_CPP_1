...
class TreeModel : public QAbstractItemModel {
	  ...
	  public:
		...
		[[nodiscard]] QModelIndex index(int32_t row, int32_t column, const QModelIndex &parent) const override; // Tworzy indeks dla elementu o podanym wierszu i kolumnie
